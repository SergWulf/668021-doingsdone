            ...
            <main class="content__main">
                ...
                <form class="form" action="register.php" method="post">
                    <div class="form__row">
                        ...
                        <input class="form__input <?php if (isset($errors_form_register['email'])): echo 'form__input--error'; endif;?>" type="text" name="email" id="email" value="<?php if (isset($data_fields_form_register['email'])): echo $data_fields_form_register['email']; endif;?>" placeholder="Введите e-mail">

                        <p class="form__message"><?php if (isset($errors_form_register['email'])):  echo $errors_form_register['email']; endif; ?></p>
                    </div>

                    <div class="form__row">
                        <label class="form__label" for="password">Пароль <sup>*</sup></label>

                        <input class="form__input <?php if (isset($errors_form_register['password'])): echo 'form__input--error'; endif;?>" type="password" name="password" id="password" value="" placeholder="Введите пароль">
                        <p class="form__message"><?php if (isset($errors_form_register['password'])):  echo $errors_form_register['password']; endif; ?></p>
                    </div>

                    <div class="form__row">
                        <label class="form__label" for="name">Имя <sup>*</sup></label>

                        <input class="form__input <?php if (isset($errors_form_register['name'])): echo 'form__input--error'; endif;?>" type="text" name="name" id="name" value="<?php if (isset($data_fields_form_register['name'])): echo $data_fields_form_register['name']; endif;?>" placeholder="Введите имя">
                        <p class="form__message"><?php if (isset($errors_form_register['name'])):  echo $errors_form_register['name']; endif; ?></p>
                    </div>
